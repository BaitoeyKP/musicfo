function ArtistCard() {
    ...
    return (
        ...
        //         />
        //     </picture>
        //     <h2 className="font-bold text-5xl max-w-[160px] hd:max-w-[320px] 4k:max-w-[640px] truncate">
        ...
        // back card
        <div className="bg-neutral bg-opacity-25 p-6 rounded-2xl h-[260px] tablet:h-[420px] hd:h-[455px] fhd:h-[485px] 4k:h-[840px] flex flex-col justify-between">
            <div className=" w-[160px] hd:w-[320px] 4k:w-[640px] max-h-[80%] overflow-hidden">
                <h2 className="font-bold text-5xl hyphens-auto">
                    TOMORROW X TOGETHER
                </h2>
                <p className="text-4xl font-medium pt-4">
                    k-pop, k-pop boy group, pop
                </p>
            </div>
            <button className="btn btn-outline text-2xl">Read more</button>
        </div>
    )
}
