function ArtistCard() {
    ...
    return (
        <div className="bg-neutral bg-opacity-25 p-4 rounded-3xl flex flex-col justify-between overflow-hidden w-full ">
            {/* <div>
                <div
                    className="h-full flex flex-col justify-around w-full gap-y-3v"
                    // onMouseOver={ }
                >
                    <img
        ...
        // back card
        // <div className="bg-neutral bg-opacity-25 p-6 rounded-3xl flex flex-col justify-between">
        //     <div className="overflow-hidden">
        //         <h2 className="font-bold text-5xl hyphens-auto">
        //             TOMORROW X TOGETHER
        //         </h2>
