function ArtistCard() {
    ...
    return (
        <div className="">
            ...
            <h2 className="font-bold text-xl hd:text-3xl fhd:text-5xl 4k:text-7xl max-w-[160px] hd:max-w-[320px] 4k:max-w-[640px] truncate">
                Artist Name sadsdasdsadasdsa
            </h2>
            <label className="swap swap-flip">
                <input type="checkbox" />
                <div className="swap-on">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none" className="text-info">
